...
export const ContactPage: React.FC<ContactPageProps> = ({ loggedUser }) => {
        ...
        <div className="space-y-6">
          ...
          <div className="card-premium">
            ...
            <p className="text-xs text-slate-400 mt-1 leading-relaxed">
              {location.endereco}, {location.detalhes} {location.cep && `- CEP ${location.cep}`}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="card-premium p-4">
        ...
        <div className="rounded-xl overflow-hidden border border-obsidian-750">
          <iframe 
            ...
            title="Mapa de Localização SFBJJ"
          ></iframe>
        </div>
      </div>
    </div>
